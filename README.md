...
トップ画面
![App Screenshot](./assets/demo_screenshot1.png)

お手伝い内容登録画面
![App Screenshot](./assets/demo_screenshot2.png)

ダッシュボード画面
![App Screenshot](./assets/demo_screenshot3.png)

お手伝い編集画面
![App Screenshot](./assets/demo_screenshot4.png)

## 💡 開発の背景・概要

4歳の娘がアイプリというアーケードゲームにハマっているのですが、お年玉を使い切ったため、
これ以上はお金がないからできないけど、自分でお手伝いをしてお小遣いを貯めたらやっていいよ、
と話したことがきっかけです。

紙のカレンダーに、お手伝いをした日とそのお小遣いの金額を書いていましたが、書き漏れが
起こったり、毎月月末の給料日に支給する合計金額の計算がめんどくさいことから、アプリ上で
管理・計算できるようにしました。
